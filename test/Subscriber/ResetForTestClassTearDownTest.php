...
final class ResetForTestClassTearDownTest extends TestCase
{
    use Helper;
    ...
    public function testReset(): void
    {
        ...
        $reportTest = new ResetForTestClassTearDown($this->collector);
        $reportTest->notify(self::fakeEventTestSuiteFinished());
